...
//
#define LIBODB_PGSQL_VERSION       200004999995150ULL
#define LIBODB_PGSQL_VERSION_STR   "2.5.0-b.15"
#define LIBODB_PGSQL_VERSION_ID    "2.5.0-b.15"
...
#  if !(LIBODB_VERSION == 200004999995150ULL)
#    error incompatible libodb version, libodb == 2.5.0-b.15 is required
#  endif
#endif
