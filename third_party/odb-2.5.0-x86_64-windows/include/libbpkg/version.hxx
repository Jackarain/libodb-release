...
//
#define LIBBPKG_VERSION       11000000000ULL
#define LIBBPKG_VERSION_STR   "0.11.0"
#define LIBBPKG_VERSION_ID    "0.11.0"

#define LIBBPKG_VERSION_MAJOR 0
#define LIBBPKG_VERSION_MINOR 11
...
#  if !(LIBBUTL_VERSION >= 11000000000ULL && LIBBUTL_VERSION < 11999990001ULL)
#    error incompatible libbutl version, libbutl ^0.11.0 is required
#  endif
#endif
