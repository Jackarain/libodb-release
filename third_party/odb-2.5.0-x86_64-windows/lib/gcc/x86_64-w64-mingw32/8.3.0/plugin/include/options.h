...
enum opt_code
{
  ...
  OPT_Wpedantic_ms_format = 336,             /* -Wpedantic-ms-format */
  /* OPT_Wplacement_new = 337, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 338,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 339,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 340,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 341,                /* -Wpointer-compare */
  ...
  OPT_Wreal_q_constant = 348,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 349,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 350,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 351,                /* -Wredundant-decls */
  OPT_Wregister = 352,                       /* -Wregister */
  OPT_Wreorder = 353,                        /* -Wreorder */
  OPT_Wrestrict = 354,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 355,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 356,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 357,           /* -Wscalar-storage-order */
  OPT_Wselector = 358,                       /* -Wselector */
  OPT_Wsequence_point = 359,                 /* -Wsequence-point */
  OPT_Wshadow = 360,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 361, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 362,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 363, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 364,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 365, */            /* -Wshadow=global */
  ...
  OPT_Wsizeof_pointer_div = 377,             /* -Wsizeof-pointer-div */
  ...
  /* OPT_Wstringop_overflow = 388, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 389,             /* -Wstringop-overflow= */
  OPT_Wstringop_truncation = 390,            /* -Wstringop-truncation */
  OPT_Wsubobject_linkage = 391,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 392,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 393,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 394,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 395,       /* -Wsuggest-attribute=malloc */
  ...
  OPT_Wswitch_unreachable = 406,             /* -Wswitch-unreachable */
  ...
  OPT_Wundeclared_selector = 420,            /* -Wundeclared-selector */
  OPT_Wundef = 421,                          /* -Wundef */
  OPT_Wundefined_do_loop = 422,              /* -Wundefined-do-loop */
  ...
  OPT_Wunused_const_variable_ = 433,         /* -Wunused-const-variable= */
  ...
  OPT_Wunused_local_typedefs = 437,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 438,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 439,               /* -Wunused-parameter */
  OPT_Wunused_result = 440,                  /* -Wunused-result */
  OPT_Wunused_value = 441,                   /* -Wunused-value */
  OPT_Wunused_variable = 442,                /* -Wunused-variable */
  OPT_Wuse_without_only = 443,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 444,                   /* -Wuseless-cast */
  OPT_Wvarargs = 445,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 446,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 447,   /* -Wvector-operation-performance */
  OPT_Wvirtual_inheritance = 448,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 449,            /* -Wvirtual-move-assign */
  OPT_Wvla = 450,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 451,               /* -Wvla-larger-than= */
  OPT_Wvolatile_register_var = 452,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 453,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 454,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzerotrip = 455,                       /* -Wzerotrip */
  OPT_Xassembler = 456,                      /* -Xassembler */
  OPT_Xlinker = 457,                         /* -Xlinker */
  OPT_Xpreprocessor = 458,                   /* -Xpreprocessor */
  OPT_Z = 459,                               /* -Z */
  OPT_ansi = 460,                            /* -ansi */
  OPT_aux_info = 461,                        /* -aux-info */
  /* OPT_aux_info_ = 462, */                 /* -aux-info= */
  OPT_auxbase = 463,                         /* -auxbase */
  OPT_auxbase_strip = 464,                   /* -auxbase-strip */
  OPT_c = 465,                               /* -c */
  OPT_coverage = 466,                        /* -coverage */
  OPT_cpp = 467,                             /* -cpp */
  OPT_cpp_ = 468,                            /* -cpp= */
  OPT_d = 469,                               /* -d */
  OPT_dumpbase = 470,                        /* -dumpbase */
  OPT_dumpdir = 471,                         /* -dumpdir */
  OPT_dumpfullversion = 472,                 /* -dumpfullversion */
  OPT_dumpmachine = 473,                     /* -dumpmachine */
  OPT_dumpspecs = 474,                       /* -dumpspecs */
  OPT_dumpversion = 475,                     /* -dumpversion */
  OPT_e = 476,                               /* -e */
  OPT_export_dynamic = 477,                  /* -export-dynamic */
  OPT_fPIC = 478,                            /* -fPIC */
  OPT_fPIE = 479,                            /* -fPIE */
  OPT_fRTS_ = 480,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 481,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 482,                   /* -fabi-version= */
  OPT_faccess_control = 483,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 484,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 485,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 486,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 487,                  /* -falign-commons */
  OPT_falign_functions = 488,                /* -falign-functions */
  OPT_falign_functions_ = 489,               /* -falign-functions= */
  OPT_falign_jumps = 490,                    /* -falign-jumps */
  OPT_falign_jumps_ = 491,                   /* -falign-jumps= */
  OPT_falign_labels = 492,                   /* -falign-labels */
  OPT_falign_labels_ = 493,                  /* -falign-labels= */
  OPT_falign_loops = 494,                    /* -falign-loops */
  OPT_falign_loops_ = 495,                   /* -falign-loops= */
  /* OPT_faligned_new = 496, */              /* -faligned-new */
  OPT_faligned_new_ = 497,                   /* -faligned-new= */
  OPT_fall_intrinsics = 498,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 499, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 500,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 501,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 502, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 503, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 504, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 505, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 506, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 507,            /* -fasan-shadow-offset= */
  OPT_fasm = 508,                            /* -fasm */
  OPT_fassociative_math = 509,               /* -fassociative-math */
  OPT_fasynchronous_unwind_tables = 510,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 511,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 512,                   /* -fauto-profile */
  OPT_fauto_profile_ = 513,                  /* -fauto-profile= */
  OPT_fautomatic = 514,                      /* -fautomatic */
  OPT_fbackslash = 515,                      /* -fbackslash */
  OPT_fbacktrace = 516,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 517,             /* -fblas-matmul-limit= */
  ...
  OPT_fbuiltin_printf = 527,                 /* -fbuiltin-printf */
  OPT_fc_prototypes = 528,                   /* -fc-prototypes */
  OPT_fcall_saved_ = 529,                    /* -fcall-saved- */
  OPT_fcall_used_ = 530,                     /* -fcall-used- */
  OPT_fcaller_saves = 531,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 532,       /* -fcanonical-system-headers */
  /* OPT_fcf_protection = 533, */            /* -fcf-protection */
  OPT_fcf_protection_ = 534,                 /* -fcf-protection= */
  OPT_fcheck_array_temporaries = 535,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 536,                /* -fcheck-data-deps */
  OPT_fcheck_new = 537,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 538,           /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 539,                         /* -fcheck= */
  OPT_fchecking = 540,                       /* -fchecking */
  OPT_fchecking_ = 541,                      /* -fchecking= */
  ...
  OPT_fchkp_flexible_struct_trailing_arrays = 546,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 547,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 548,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 549,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 550, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 551,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 552,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 553,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 554, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 555,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 556,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 557,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 558,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 559,/* -fchkp-zero-input-bounds-for-main */
  OPT_fcilkplus = 560,                       /* -fcilkplus */
  OPT_fcoarray_ = 561,                       /* -fcoarray= */
  OPT_fcode_hoisting = 562,                  /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 563,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 564,                         /* -fcommon */
  OPT_fcompare_debug = 565,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 566,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 567,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 568,                   /* -fcompare-elim */
  ...
  OPT_fconstexpr_loop_limit_ = 575,          /* -fconstexpr-loop-limit= */
  OPT_fconvert_ = 576,                       /* -fconvert= */
  OPT_fcprop_registers = 577,                /* -fcprop-registers */
  OPT_fcray_pointer = 578,                   /* -fcray-pointer */
  OPT_fcrossjumping = 579,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 580,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 581, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 582,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 583,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 584,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 585,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 586,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 587,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 588,                       /* -fdbg-cnt= */
  OPT_fdce = 589,                            /* -fdce */
  OPT_fdebug_cpp = 590,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 591,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 592,            /* -fdebug-types-section */
  OPT_fdec = 593,                            /* -fdec */
  OPT_fdec_intrinsic_ints = 594,             /* -fdec-intrinsic-ints */
  OPT_fdec_math = 595,                       /* -fdec-math */
  OPT_fdec_static = 596,                     /* -fdec-static */
  OPT_fdec_structure = 597,                  /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 598,              /* -fdeclone-ctor-dtor */
  OPT_fdeduce_init_list = 599,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 600,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 601, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 602,              /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 603,                /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 604,                /* -fdefault-real-16 */
  ...
  OPT_fdiagnostics_generate_patch = 615,     /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_parseable_fixits = 616,   /* -fdiagnostics-parseable-fixits */
  ...
  OPT_fdiagnostics_show_template_tree = 620, /* -fdiagnostics-show-template-tree */
  OPT_fdirectives_only = 621,                /* -fdirectives-only */
  OPT_fdisable_ = 622,                       /* -fdisable- */
  OPT_fdollar_ok = 623,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 624,         /* -fdollars-in-identifiers */
  OPT_fdse = 625,                            /* -fdse */
  OPT_fdump_ = 626,                          /* -fdump- */
  OPT_fdump_ada_spec = 627,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 628,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 629, */                /* -fdump-core */
  OPT_fdump_final_insns = 630,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 631,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 632,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 633,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 634,                  /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 635,        /* -fdump-internal-locations */
  OPT_fdump_noaddr = 636,                    /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 637, */          /* -fdump-parse-tree */
  OPT_fdump_passes = 638,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 639,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 640,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 641,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 642,                 /* -fearly-inlining */
  OPT_felide_constructors = 643,             /* -felide-constructors */
  OPT_felide_type = 644,                     /* -felide-type */
  ...
  OPT_fenforce_eh_specs = 653,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 654, */           /* -fenum-int-equiv */
  OPT_fexceptions = 655,                     /* -fexceptions */
  OPT_fexcess_precision_ = 656,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 657,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 658,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 659,           /* -fext-numeric-literals */
  OPT_fextended_identifiers = 660,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 661,                /* -fextern-tls-init */
  OPT_fexternal_blas = 662,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 663, */       /* -fexternal-templates */
  OPT_ff2c = 664,                            /* -ff2c */
  OPT_ffast_math = 665,                      /* -ffast-math */
  OPT_ffat_lto_objects = 666,                /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 667,               /* -ffile-prefix-map= */
  OPT_ffinite_math_only = 668,               /* -ffinite-math-only */
  OPT_ffixed_ = 669,                         /* -ffixed- */
  OPT_ffixed_form = 670,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 671,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 672,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 673,                    /* -ffloat-store */
  OPT_ffor_scope = 674,                      /* -ffor-scope */
  /* OPT_fforce_addr = 675, */               /* -fforce-addr */
  OPT_fforward_propagate = 676,              /* -fforward-propagate */
  OPT_ffp_contract_ = 677,                   /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 678,         /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 679,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 680,                      /* -ffpe-trap= */
  OPT_ffree_form = 681,                      /* -ffree-form */
  OPT_ffree_line_length_ = 682,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 683,          /* -ffree-line-length-none */
  OPT_ffreestanding = 684,                   /* -ffreestanding */
  OPT_ffriend_injection = 685,               /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 686,      /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 687,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 688,                   /* -ffunction-cse */
  OPT_ffunction_sections = 689,              /* -ffunction-sections */
  OPT_fgcse = 690,                           /* -fgcse */
  OPT_fgcse_after_reload = 691,              /* -fgcse-after-reload */
  OPT_fgcse_las = 692,                       /* -fgcse-las */
  OPT_fgcse_lm = 693,                        /* -fgcse-lm */
  OPT_fgcse_sm = 694,                        /* -fgcse-sm */
  OPT_fgimple = 695,                         /* -fgimple */
  OPT_fgnat_encodings_ = 696,                /* -fgnat-encodings= */
  OPT_fgnu_keywords = 697,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 698,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 699,                         /* -fgnu-tm */
  OPT_fgnu_unique = 700,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 701,                   /* -fgnu89-inline */
  OPT_fgo_c_header_ = 702,                   /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 703,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 704,           /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 705,           /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 706,                /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 707,          /* -fgo-debug-escape-hash= */
  OPT_fgo_dump_ = 708,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 709,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 710,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 711,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 712,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 713,                       /* -fgraphite */
  OPT_fgraphite_identity = 714,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 715,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 716, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 717, */        /* -fhandle-exceptions */
  /* OPT_fhelp = 718, */                     /* -fhelp */
  ...
  OPT_finit_derived = 734,                   /* -finit-derived */
  OPT_finit_integer_ = 735,                  /* -finit-integer= */
  OPT_finit_local_zero = 736,                /* -finit-local-zero */
  OPT_finit_logical_ = 737,                  /* -finit-logical= */
  OPT_finit_real_ = 738,                     /* -finit-real= */
  OPT_finline = 739,                         /* -finline */
  OPT_finline_atomics = 740,                 /* -finline-atomics */
  OPT_finline_functions = 741,               /* -finline-functions */
  OPT_finline_functions_called_once = 742,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 743, */            /* -finline-limit- */
  OPT_finline_limit_ = 744,                  /* -finline-limit= */
  OPT_finline_matmul_limit_ = 745,           /* -finline-matmul-limit= */
  OPT_finline_small_functions = 746,         /* -finline-small-functions */
  OPT_finput_charset_ = 747,                 /* -finput-charset= */
  OPT_finstrument_functions = 748,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 749,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 750,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 751,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 752,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 753,        /* -fintrinsic-modules-path= */
  OPT_fipa_bit_cp = 754,                     /* -fipa-bit-cp */
  ...
  OPT_fipa_vrp = 769,                        /* -fipa-vrp */
  OPT_fira_algorithm_ = 770,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 771,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 772,              /* -fira-loop-pressure */
  OPT_fira_region_ = 773,                    /* -fira-region= */
  OPT_fira_share_save_slots = 774,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 775,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 776,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 777,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 778,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 779,               /* -fivar-visibility= */
  OPT_fivopts = 780,                         /* -fivopts */
  OPT_fjump_tables = 781,                    /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 782,             /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 783,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 784,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 785,             /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 786,          /* -fkeep-static-functions */
  /* OPT_flabels_ok = 787, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 788,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 789,             /* -fleading-underscore */
  OPT_flifetime_dse = 790,                   /* -flifetime-dse */
  OPT_flifetime_dse_ = 791,                  /* -flifetime-dse= */
  OPT_flimit_function_alignment = 792,       /* -flimit-function-alignment */
  ...
  OPT_fmacro_prefix_map_ = 814,              /* -fmacro-prefix-map= */
  ...
  OPT_fnew_inheriting_ctors = 837,           /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 838,               /* -fnew-ttp-matching */
  OPT_fnext_runtime = 839,                   /* -fnext-runtime */
  OPT_fnil_receivers = 840,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 841,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 842,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 843, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 844,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 845,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 846,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 847,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 848,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 849,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 850,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 851,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 852,                 /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 853,                   /* -foffload-abi= */
  OPT_foffload_ = 854,                       /* -foffload= */
  OPT_fomit_frame_pointer = 855,             /* -fomit-frame-pointer */
  OPT_fopenacc = 856,                        /* -fopenacc */
  OPT_fopenacc_dim_ = 857,                   /* -fopenacc-dim= */
  OPT_fopenmp = 858,                         /* -fopenmp */
  OPT_fopenmp_simd = 859,                    /* -fopenmp-simd */
  OPT_foperator_names = 860,                 /* -foperator-names */
  OPT_fopt_info = 861,                       /* -fopt-info */
  OPT_fopt_info_ = 862,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 863, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 864,         /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 865,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 866, */           /* -foptional-diags */
  OPT_fpack_derived = 867,                   /* -fpack-derived */
  OPT_fpack_struct = 868,                    /* -fpack-struct */
  OPT_fpack_struct_ = 869,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 870,               /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 871,      /* -fpatchable-function-entry= */
  ...
  OPT_fpermitted_flt_eval_methods_ = 879,    /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 880,                            /* -fpic */
  OPT_fpie = 881,                            /* -fpie */
  OPT_fplan9_extensions = 882,               /* -fplan9-extensions */
  OPT_fplt = 883,                            /* -fplt */
  OPT_fplugin_arg_ = 884,                    /* -fplugin-arg- */
  OPT_fplugin_ = 885,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 886,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 887,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 888,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 889,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 890,                   /* -fpreprocessed */
  OPT_fpretty_templates = 891,               /* -fpretty-templates */
  OPT_fprintf_return_value = 892,            /* -fprintf-return-value */
  OPT_fprofile = 893,                        /* -fprofile */
  OPT_fprofile_abs_path = 894,               /* -fprofile-abs-path */
  OPT_fprofile_arcs = 895,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 896,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 897,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 898,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 899,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 900,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 901,                 /* -fprofile-report */
  OPT_fprofile_update_ = 902,                /* -fprofile-update= */
  ...
  OPT_free = 922,                            /* -free */
  OPT_freg_struct_return = 923,              /* -freg-struct-return */
  /* OPT_fregmove = 924, */                  /* -fregmove */
  OPT_frename_registers = 925,               /* -frename-registers */
  OPT_freorder_blocks = 926,                 /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 927,      /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 928,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 929,              /* -freorder-functions */
  OPT_frepack_arrays = 930,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 931,           /* -freplace-objc-classes */
  OPT_frepo = 932,                           /* -frepo */
  OPT_freport_bug = 933,                     /* -freport-bug */
  OPT_frequire_return_statement = 934,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 935,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 936, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 937,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 938,                    /* -fresolution= */
  OPT_frounding_math = 939,                  /* -frounding-math */
  OPT_frtti = 940,                           /* -frtti */
  OPT_fsanitize_address_use_after_scope = 941,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 942,             /* -fsanitize-coverage= */
  ...
  OPT_fsched_critical_path_heuristic = 948,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 949,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 950,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 951,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 952,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 953,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 954,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 955,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 956,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 957,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 958,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 959,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 960,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 961,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 962,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 963,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 964,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 965, */        /* -fsched2-use-traces */
  OPT_fschedule_fusion = 966,                /* -fschedule-fusion */
  OPT_fschedule_insns = 967,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 968,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 969,              /* -fsecond-underscore */
  OPT_fsection_anchors = 970,                /* -fsection-anchors */
  /* OPT_fsee = 971, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 972,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 973,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 974, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 975,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 976,          /* -fselective-scheduling2 */
  OPT_fself_test_ = 977,                     /* -fself-test= */
  OPT_fsemantic_interposition = 978,         /* -fsemantic-interposition */
  OPT_fset_stack_executable = 979,           /* -fset-stack-executable */
  ...
  OPT_fwritable_relocated_rdata = 1137,      /* -fwritable-relocated-rdata */
  ...
  OPT_g = 1142,                              /* -g */
  OPT_gant = 1143,                           /* -gant */
  OPT_gas_loc_support = 1144,                /* -gas-loc-support */
  OPT_gas_locview_support = 1145,            /* -gas-locview-support */
  /* OPT_gcoff = 1146, */                    /* -gcoff */
  /* OPT_gcoff1 = 1147, */                   /* -gcoff1 */
  /* OPT_gcoff2 = 1148, */                   /* -gcoff2 */
  /* OPT_gcoff3 = 1149, */                   /* -gcoff3 */
  OPT_gcolumn_info = 1150,                   /* -gcolumn-info */
  OPT_gdwarf = 1151,                         /* -gdwarf */
  OPT_gdwarf_ = 1152,                        /* -gdwarf- */
  OPT_gen_decls = 1153,                      /* -gen-decls */
  OPT_ggdb = 1154,                           /* -ggdb */
  OPT_ggnu_pubnames = 1155,                  /* -ggnu-pubnames */
  OPT_ginline_points = 1156,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1157, /* -ginternal-reset-location-views */
  OPT_gnat = 1158,                           /* -gnat */
  OPT_gnatO = 1159,                          /* -gnatO */
  OPT_gno_ = 1160,                           /* -gno- */
  OPT_gno_pubnames = 1161,                   /* -gno-pubnames */
  OPT_gpubnames = 1162,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1163,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1164,                   /* -gsplit-dwarf */
  OPT_gstabs = 1165,                         /* -gstabs */
  OPT_gstabs_ = 1166,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1167,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1168,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1169,                        /* -gtoggle */
  OPT_gvariable_location_views = 1170,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1171,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1172,                           /* -gvms */
  OPT_gxcoff = 1173,                         /* -gxcoff */
  OPT_gxcoff_ = 1174,                        /* -gxcoff+ */
  OPT_gz = 1175,                             /* -gz */
  OPT_gz_ = 1176,                            /* -gz= */
  OPT_h = 1177,                              /* -h */
  OPT_idirafter = 1178,                      /* -idirafter */
  OPT_imacros = 1179,                        /* -imacros */
  OPT_imultiarch = 1180,                     /* -imultiarch */
  OPT_imultilib = 1181,                      /* -imultilib */
  OPT_include = 1182,                        /* -include */
  OPT_iplugindir_ = 1183,                    /* -iplugindir= */
  OPT_iprefix = 1184,                        /* -iprefix */
  OPT_iquote = 1185,                         /* -iquote */
  OPT_isysroot = 1186,                       /* -isysroot */
  OPT_isystem = 1187,                        /* -isystem */
  OPT_iwithprefix = 1188,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1189,              /* -iwithprefixbefore */
  OPT_k8 = 1190,                             /* -k8 */
  OPT_l = 1191,                              /* -l */
  OPT_lang_asm = 1192,                       /* -lang-asm */
  OPT_m128bit_long_double = 1193,            /* -m128bit-long-double */
  OPT_m16 = 1194,                            /* -m16 */
  OPT_m32 = 1195,                            /* -m32 */
  OPT_m3dnow = 1196,                         /* -m3dnow */
  OPT_m3dnowa = 1197,                        /* -m3dnowa */
  OPT_m64 = 1198,                            /* -m64 */
  OPT_m80387 = 1199,                         /* -m80387 */
  OPT_m8bit_idiv = 1200,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1201,             /* -m96bit-long-double */
  OPT_mabi_ = 1202,                          /* -mabi= */
  OPT_mabm = 1203,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1204,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1205,                 /* -maddress-mode= */
  OPT_madx = 1206,                           /* -madx */
  OPT_maes = 1207,                           /* -maes */
  OPT_malign_data_ = 1208,                   /* -malign-data= */
  OPT_malign_double = 1209,                  /* -malign-double */
  OPT_malign_functions_ = 1210,              /* -malign-functions= */
  OPT_malign_jumps_ = 1211,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1212,                  /* -malign-loops= */
  OPT_malign_stringops = 1213,               /* -malign-stringops */
  OPT_march_ = 1214,                         /* -march= */
  OPT_masm_ = 1215,                          /* -masm= */
  OPT_mavx = 1216,                           /* -mavx */
  OPT_mavx2 = 1217,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1218,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1219,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1220,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1221,                  /* -mavx5124vnniw */
  OPT_mavx512bitalg = 1222,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1223,                      /* -mavx512bw */
  OPT_mavx512cd = 1224,                      /* -mavx512cd */
  OPT_mavx512dq = 1225,                      /* -mavx512dq */
  OPT_mavx512er = 1226,                      /* -mavx512er */
  OPT_mavx512f = 1227,                       /* -mavx512f */
  OPT_mavx512ifma = 1228,                    /* -mavx512ifma */
  OPT_mavx512pf = 1229,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1230,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1231,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1232,                      /* -mavx512vl */
  OPT_mavx512vnni = 1233,                    /* -mavx512vnni */
  OPT_mavx512vpopcntdq = 1234,               /* -mavx512vpopcntdq */
  OPT_mbmi = 1235,                           /* -mbmi */
  OPT_mbmi2 = 1236,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1237,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1238,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1239,                    /* -mcet-switch */
  OPT_mcld = 1240,                           /* -mcld */
  OPT_mclflushopt = 1241,                    /* -mclflushopt */
  OPT_mclwb = 1242,                          /* -mclwb */
  OPT_mclzero = 1243,                        /* -mclzero */
  OPT_mcmodel_ = 1244,                       /* -mcmodel= */
  OPT_mconsole = 1245,                       /* -mconsole */
  /* OPT_mcpu_ = 1246, */                    /* -mcpu= */
  OPT_mcrc32 = 1247,                         /* -mcrc32 */
  OPT_mcrtdll_ = 1248,                       /* -mcrtdll= */
  OPT_mcx16 = 1249,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1250,            /* -mdispatch-scheduler */
  OPT_mdll = 1251,                           /* -mdll */
  OPT_mdump_tune_features = 1252,            /* -mdump-tune-features */
  OPT_mf16c = 1253,                          /* -mf16c */
  OPT_mfancy_math_387 = 1254,                /* -mfancy-math-387 */
  OPT_mfentry = 1255,                        /* -mfentry */
  OPT_mfma = 1256,                           /* -mfma */
  OPT_mfma4 = 1257,                          /* -mfma4 */
  OPT_mforce_drap = 1258,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1259,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1260,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1261,                       /* -mfpmath= */
  OPT_mfsgsbase = 1262,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1263,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1264, */              /* -mfused-madd */
  OPT_mfxsr = 1265,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1266,             /* -mgeneral-regs-only */
  OPT_mgfni = 1267,                          /* -mgfni */
  OPT_mhard_float = 1268,                    /* -mhard-float */
  OPT_mhle = 1269,                           /* -mhle */
  OPT_miamcu = 1270,                         /* -miamcu */
  OPT_mieee_fp = 1271,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1272,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1273,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1274,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1275,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1276,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1277, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1278,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1279,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1280,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1281,                /* -mlong-double-80 */
  OPT_mlwp = 1282,                           /* -mlwp */
  OPT_mlzcnt = 1283,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1284,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1285,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1286,                  /* -mmitigate-rop */
  OPT_mmmx = 1287,                           /* -mmmx */
  OPT_mmovbe = 1288,                         /* -mmovbe */
  OPT_mmovdir64b = 1289,                     /* -mmovdir64b */
  OPT_mmovdiri = 1290,                       /* -mmovdiri */
  OPT_mmpx = 1291,                           /* -mmpx */
  OPT_mms_bitfields = 1292,                  /* -mms-bitfields */
  OPT_mmwaitx = 1293,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1294,            /* -mno-align-stringops */
  OPT_mno_default = 1295,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1296,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1297,                  /* -mno-push-args */
  OPT_mno_red_zone = 1298,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1299,                       /* -mno-sse4 */
  OPT_mnop_fun_dllimport = 1300,             /* -mnop-fun-dllimport */
  OPT_mnop_mcount = 1301,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1302,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1303,                          /* -mpc32 */
  OPT_mpc64 = 1304,                          /* -mpc64 */
  OPT_mpc80 = 1305,                          /* -mpc80 */
  OPT_mpclmul = 1306,                        /* -mpclmul */
  OPT_mpcommit = 1307,                       /* -mpcommit */
  OPT_mpconfig = 1308,                       /* -mpconfig */
  OPT_mpe_aligned_commons = 1309,            /* -mpe-aligned-commons */
  OPT_mpku = 1310,                           /* -mpku */
  OPT_mpopcnt = 1311,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1312, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1313,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1314,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1315,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1316,                        /* -mprfchw */
  OPT_mpush_args = 1317,                     /* -mpush-args */
  OPT_mrdpid = 1318,                         /* -mrdpid */
  OPT_mrdrnd = 1319,                         /* -mrdrnd */
  OPT_mrdseed = 1320,                        /* -mrdseed */
  OPT_mrecip = 1321,                         /* -mrecip */
  OPT_mrecip_ = 1322,                        /* -mrecip= */
  OPT_mrecord_mcount = 1323,                 /* -mrecord-mcount */
  OPT_mred_zone = 1324,                      /* -mred-zone */
  OPT_mregparm_ = 1325,                      /* -mregparm= */
  OPT_mrtd = 1326,                           /* -mrtd */
  OPT_mrtm = 1327,                           /* -mrtm */
  OPT_msahf = 1328,                          /* -msahf */
  OPT_msgx = 1329,                           /* -msgx */
  OPT_msha = 1330,                           /* -msha */
  OPT_mshstk = 1331,                         /* -mshstk */
  OPT_mskip_rax_setup = 1332,                /* -mskip-rax-setup */
  OPT_msoft_float = 1333,                    /* -msoft-float */
  OPT_msse = 1334,                           /* -msse */
  OPT_msse2 = 1335,                          /* -msse2 */
  OPT_msse2avx = 1336,                       /* -msse2avx */
  OPT_msse3 = 1337,                          /* -msse3 */
  OPT_msse4 = 1338,                          /* -msse4 */
  OPT_msse4_1 = 1339,                        /* -msse4.1 */
  OPT_msse4_2 = 1340,                        /* -msse4.2 */
  OPT_msse4a = 1341,                         /* -msse4a */
  /* OPT_msse5 = 1342, */                    /* -msse5 */
  OPT_msseregparm = 1343,                    /* -msseregparm */
  OPT_mssse3 = 1344,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1345,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1346, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1347,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1348, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1349,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1350,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1351,            /* -mstringop-strategy= */
  OPT_mstv = 1352,                           /* -mstv */
  OPT_mtbm = 1353,                           /* -mtbm */
  OPT_mthreads = 1354,                       /* -mthreads */
  OPT_mtls_dialect_ = 1355,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1356,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1357,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1358,                         /* -mtune= */
  OPT_municode = 1359,                       /* -municode */
  OPT_muse_libstdc_wrappers = 1360,          /* -muse-libstdc-wrappers */
  OPT_mvaes = 1361,                          /* -mvaes */
  OPT_mveclibabi_ = 1362,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1363,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1364,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1365,                    /* -mvzeroupper */
  OPT_mwbnoinvd = 1366,                      /* -mwbnoinvd */
  OPT_mwin32 = 1367,                         /* -mwin32 */
  OPT_mwindows = 1368,                       /* -mwindows */
  OPT_mx32 = 1369,                           /* -mx32 */
  OPT_mxop = 1370,                           /* -mxop */
  OPT_mxsave = 1371,                         /* -mxsave */
  OPT_mxsavec = 1372,                        /* -mxsavec */
  OPT_mxsaveopt = 1373,                      /* -mxsaveopt */
  OPT_mxsaves = 1374,                        /* -mxsaves */
  OPT_n = 1375,                              /* -n */
  OPT_no_canonical_prefixes = 1376,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1377,              /* -no-integrated-cpp */
  OPT_no_pie = 1378,                         /* -no-pie */
  OPT_no_pthread = 1379,                     /* -no-pthread */
  OPT_nocpp = 1380,                          /* -nocpp */
  OPT_nodefaultlibs = 1381,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1382,                   /* -nostartfiles */
  OPT_nostdinc = 1383,                       /* -nostdinc */
  OPT_nostdinc__ = 1384,                     /* -nostdinc++ */
  OPT_nostdlib = 1385,                       /* -nostdlib */
  OPT_o = 1386,                              /* -o */
  OPT_p = 1387,                              /* -p */
  OPT_pass_exit_codes = 1388,                /* -pass-exit-codes */
  /* OPT_pedantic = 1389, */                 /* -pedantic */
  OPT_pedantic_errors = 1390,                /* -pedantic-errors */
  OPT_pg = 1391,                             /* -pg */
  OPT_pie = 1392,                            /* -pie */
  OPT_pipe = 1393,                           /* -pipe */
  OPT_posix = 1394,                          /* -posix */
  OPT_print_file_name_ = 1395,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1396,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1397,          /* -print-multi-directory */
  OPT_print_multi_lib = 1398,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1399,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1400,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1401,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1402,               /* -print-prog-name= */
  OPT_print_search_dirs = 1403,              /* -print-search-dirs */
  OPT_print_sysroot = 1404,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1405,   /* -print-sysroot-headers-suffix */
  OPT_pthread = 1406,                        /* -pthread */
  OPT_quiet = 1407,                          /* -quiet */
  OPT_r = 1408,                              /* -r */
  OPT_remap = 1409,                          /* -remap */
  OPT_s = 1410,                              /* -s */
  OPT_save_temps = 1411,                     /* -save-temps */
  OPT_save_temps_ = 1412,                    /* -save-temps= */
  OPT_shared = 1413,                         /* -shared */
  OPT_shared_libgcc = 1414,                  /* -shared-libgcc */
  /* OPT_specs = 1415, */                    /* -specs */
  OPT_specs_ = 1416,                         /* -specs= */
  OPT_static = 1417,                         /* -static */
  OPT_static_libasan = 1418,                 /* -static-libasan */
  OPT_static_libgcc = 1419,                  /* -static-libgcc */
  OPT_static_libgfortran = 1420,             /* -static-libgfortran */
  OPT_static_libgo = 1421,                   /* -static-libgo */
  OPT_static_liblsan = 1422,                 /* -static-liblsan */
  OPT_static_libmpx = 1423,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1424,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1425,               /* -static-libstdc++ */
  OPT_static_libtsan = 1426,                 /* -static-libtsan */
  OPT_static_libubsan = 1427,                /* -static-libubsan */
  OPT_static_pie = 1428,                     /* -static-pie */
  /* OPT_std_c__03 = 1429, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1430, */                /* -std=c++0x */
  OPT_std_c__11 = 1431,                      /* -std=c++11 */
  OPT_std_c__14 = 1432,                      /* -std=c++14 */
  OPT_std_c__17 = 1433,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1434, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1435, */                /* -std=c++1z */
  OPT_std_c__2a = 1436,                      /* -std=c++2a */
  OPT_std_c__98 = 1437,                      /* -std=c++98 */
  OPT_std_c11 = 1438,                        /* -std=c11 */
  OPT_std_c17 = 1439,                        /* -std=c17 */
  /* OPT_std_c18 = 1440, */                  /* -std=c18 */
  /* OPT_std_c1x = 1441, */                  /* -std=c1x */
  /* OPT_std_c89 = 1442, */                  /* -std=c89 */
  OPT_std_c90 = 1443,                        /* -std=c90 */
  OPT_std_c99 = 1444,                        /* -std=c99 */
  /* OPT_std_c9x = 1445, */                  /* -std=c9x */
  OPT_std_f2003 = 1446,                      /* -std=f2003 */
  OPT_std_f2008 = 1447,                      /* -std=f2008 */
  OPT_std_f2008ts = 1448,                    /* -std=f2008ts */
  OPT_std_f2018 = 1449,                      /* -std=f2018 */
  OPT_std_f95 = 1450,                        /* -std=f95 */
  OPT_std_gnu = 1451,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1452, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1453, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1454,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1455,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1456,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1457, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1458, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1459,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1460,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1461,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1462,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1463, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1464, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1465, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1466,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1467,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1468, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1469, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1470,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1471, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1472, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1473, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1474, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1475, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1476,                     /* -std=legacy */
  OPT_symbolic = 1477,                       /* -symbolic */
  OPT_t = 1478,                              /* -t */
  OPT_time = 1479,                           /* -time */
  OPT_time_ = 1480,                          /* -time= */
  OPT_traditional = 1481,                    /* -traditional */
  OPT_traditional_cpp = 1482,                /* -traditional-cpp */
  OPT_trigraphs = 1483,                      /* -trigraphs */
  OPT_u = 1484,                              /* -u */
  OPT_undef = 1485,                          /* -undef */
  OPT_v = 1486,                              /* -v */
  OPT_version = 1487,                        /* -version */
  OPT_w = 1488,                              /* -w */
  OPT_wrapper = 1489,                        /* -wrapper */
  OPT_x = 1490,                              /* -x */
  OPT_z = 1491,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
